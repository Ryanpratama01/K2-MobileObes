...
import 'page/Statistikpage.dart';  
...
class _BerandaPageState extends State<BerandaPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Background gradient matching splash and login screen
          Container(
  ...
  isCurved: true,
  color: Theme.of(context).primaryColor, // Mengambil warna dari tema
  barWidth: 3,
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildStatusRow(
                            ...
                            value: weightHistory.isEmpty ? "Belum ada data" : "${weightHistory.last.toStringAsFixed(1)} kg"
                          ),
